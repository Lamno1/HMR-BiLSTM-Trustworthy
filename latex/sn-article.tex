...
\title[Towards Trustworthy ECG Classification with HMR-BiLSTM]{HMR-BiLSTM: Towards Trustworthy ECG Arrhythmia Classification via a Robust, Interpretable Hybrid Memory Residual BiLSTM}

\author{\fnm{Van Thong} \sur{NGUYEN} [0009-0007-9360-9112]}\email{nguyenthong111206@gmail.com}
...
\keywords{ECG arrhythmia classification, Trustworthy AI, Interpretable AI, Robust medical AI, Bidirectional LSTM, Residual Memory Control, Adversarial robustness, Calibration and uncertainty quantification, Inter-patient evaluation.}
...
\textbf{Funding.} This research is funded by the University of Economics Ho Chi Minh City, Vietnam (UEH).

\textbf{Conflict of interest/Competing interests.} The authors declare no conflict of interest.

\textbf{Ethics approval.} Not applicable. This study uses only the publicly available, de-identified MIT-BIH Arrhythmia Database (PhysioNet); no new data were collected from human or animal subjects, and no identifiable patient information is used.

\textbf{Consent to participate.} Not applicable.

\textbf{Consent for publication.} Not applicable.

\textbf{Availability of data and materials.} The ECG data used in this study are publicly available from the MIT-BIH Arrhythmia Database (PhysioNet).

\textbf{Code availability.} The implementation code, experimental configurations, and evaluation results are available at: \url{https://github.com/Lamno1/HMR-BiLSTM-Trustworthy}

\textbf{Authors' contributions.} \emph{[To be finalised alongside the author list.]}
