\PassOptionsToPackage{draft}{graphicx}  % draft: boxes instead of images -> faster compile
...
\author*{\fnm{Quoc Hung} \sur{NGUYEN}\textsuperscript{*} [0000-0002-6363-0160]}\email{hungngq@ueh.edu.vn}
\author{\fnm{Dai Phong} \sur{LUU NGUYEN} [0009-0000-1758-3319]}
\author{\fnm{Khoi Nguyen} \sur{TRAN} [0009-0004-3486-1607]}
\author{\fnm{Dang Tho} \sur{LE} [0009-0008-6323-5778]}
\author{\fnm{My Phung} \sur{LE} [0009-0008-8566-0409]}
\author{\fnm{Van Thong} \sur{NGUYEN} [0009-0007-9360-9112]}
...
The ECG datasets used in this study are publicly available from the MIT-BIH Arrhythmia Database (PhysioNet). The implementation code, experimental configurations, and evaluation results are available at: \url{https://github.com/tn1-ai/HMR-BILSTM}
